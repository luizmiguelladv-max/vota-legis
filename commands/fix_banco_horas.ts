...
export default class FixBancoHoras extends BaseCommand {
    static commandName = 'db:fix_banco_horas'
    static description = 'Recria tabela banco_horas com estrutura correta'
    ...
    async run() {
        ...
        try {
            const sqlPath = join(process.cwd(), 'database', 'migrations', 'tenant', '003_fix_banco_horas.sql')
            ...
            this.logger.success('Tabela banco_horas recriada!')
        } catch (error: any) {
